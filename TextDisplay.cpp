...
void displayInfo(GxEPD2_GFX& display, char* row1, char* row2, char* row3, char* row4){
  ...
  do
  {
    ...
    //  setCursor(how much to the right, how much down)
...
void helloWorld(GxEPD2_GFX& display, int time)
{
  ...
  do
  {
    ...
    //  setCursor(how much to the right, how much down)
    display.setCursor(0, 20);
    display.println("K-Ci & JoJo");
    //display.setCursor(50, 45);
    display.println("All My Life All");
    //display.setCursor(50, 70);
    display.print("0:49 / 0:");
